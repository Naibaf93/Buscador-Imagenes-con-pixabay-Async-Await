...
function buscarImagenes(termino) {
    const key = '47081279-bec481177116f194a9c59e1bf';
            ...
            <div class="w-1/2 md:w-1/3 lg:w-1/4 p-3 mb-4">
                <div class="bg-white">
                    ...
                    <div class="p-4">
                        ...
                        href="${largeImageURL}" targer="_blank" rel="noopener noreferrer">
                            Ver Imagen
                        </a>    
                    </div>
                </div>    
...
function imprimirPaginador() {
    ...
    while(true) {
        ...
        boton.classList.add('siguiente' , 'mx-auto', 'bg-yellow-400', 'px-4', 'py-1', 'mr-2', 'font-bold', 'mb-4', 'uppercase', 
            'rounded');
